...
public class InboxForEmployeeHomeActivity extends AppCompatActivity implements com.google.android.gms.location.LocationListener, GoogleApiClient.ConnectionCallbacks,
...
//    private String strWorkLocation = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inbox_for_employee_home);

        imgBack=findViewById(R.id.imgBack);

        msg=findViewById(R.id.msg);
        inBoxUtil= new InBoxUtil();

        routPointInbox = (RoutPointClass) getIntent().getExtras().getSerializable("model");

        msg.setText(inBoxUtil.getInBoxMessagePrefrence(this));
            ...
            if (location.getLatitude() != 0.0 && location.getLongitude() != 0.0) {
                ...
                if (location.getLatitude() != 0.0 && location.getLongitude() != 0.0) {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(InboxForEmployeeHomeActivity.this, LocationToRouteActivity.class);
                        ...
                        Toast.makeText(InboxForEmployeeHomeActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        } catch (Exception e) {
